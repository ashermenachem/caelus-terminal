...
```bash
curl -fsSL https://raw.githubusercontent.com/ashermenachem/caelus-agent/v0.1.10/scripts/install-macos.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/ashermenachem/caelus-agent/v0.1.10/scripts/uninstall-macos.sh | bash
```
